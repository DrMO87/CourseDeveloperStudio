---
title: "Educational Decisions & Curricular Trace — Lec 12"
session_code: "Lec 12"
...
# 🏛️ Curricular Decisions & Pedagogical Design Record: Lec 12
...
**Topic**: Chromatographic Theory: Plate Height (H), Resolution (Rs), Van Deemter Equation  
**Contact Hours**: 1 Hour Theory, 2 Hours Practical Laboratory (Comprehensive Practical Revision & Station Review)  
...
[Level 3: Apply]       --> Calculate numerical quantities using $$N = 16 \left(\frac{t_R}{W}\right)^2 = 5.545 \left(\frac{t_R}{W_{0.5}}\right)^2 \quad | \quad H = \frac{L}{N} = A + \frac{B}{u} + C \cdot u \quad | \quad R_s = \frac{\sqrt{N}}{4} \left(\frac{\alpha - 1}{\alpha}\right) \left(\frac{k_2'}{1 + k_2'}\right)$$.
...
2. **Intermediate Cognitive Ascent (Understand & Apply)**:
   - Walk step-by-step through mathematical calculations ($$N = 16 \left(\frac{t_R}{W}\right)^2 = 5.545 \left(\frac{t_R}{W_{0.5}}\right)^2 \quad | \quad H = \frac{L}{N} = A + \frac{B}{u} + C \cdot u \quad | \quad R_s = \frac{\sqrt{N}}{4} \left(\frac{\alpha - 1}{\alpha}\right) \left(\frac{k_2'}{1 + k_2'}\right)$$) with explicit units ($L \cdot mol^{-1} \cdot cm^{-1}$ or theoretical plates $N$).
...
> A pure physical-mathematical derivation of band broadening, kinetic rate theory, and chromatographic optimization equations. Zero clinical pharmacology is forced.
> 
...
Non-linear preparative overload isotherm mathematics.
